# coding: utf-8
"""
A Danish version of Vader developed for sentida
"""
...
class SentimentIntensityAnalyzer(object):
    ...
    def __init__(self, lexicon: Optional[dict] = None, emoji_lexicon: Optional[dict]=None):
